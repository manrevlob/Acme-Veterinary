  ...
  <div id="menucete" class="collapse navbar-collapse navbar-ex1-collapse">
	<ul class="nav navbar-nav">
			...
			<li><a href="register/createVeterinary.do"> <spring:message
					...
					<li class="dropdown">
    				    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          					<spring:message	code="master.page.manage" /> <b class="caret"></b>
        				</a>
		...
		<security:authorize access="isAuthenticated()">
			...
			<li class="dropdown">
    		    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
         				<spring:message	code="master.page.profile" /> (<security:authentication	property="principal.username" />) <b class="caret"></b>
        		</a>
        		<ul class="dropdown-menu">
